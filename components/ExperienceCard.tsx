...
export default function ExperienceCard({
  ...
  return (
    <article className='flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[300px] md:w-[450px] lg:w-[600px] snap-center backdrop-blur-sm hover:backdrop-blur-lg p-10 border border-[#292929] hover:opacity-100 cursor-pointer transition duration-200 overflow-hidden mt-20 hover:border-[#F7AB0A] z-20'>
      <motion.img
